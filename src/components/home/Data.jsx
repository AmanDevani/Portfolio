...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title">Aman Devani
            <svg
                width="36"
                height="36"
                viewBox="0 0 48 48"
            ...
            <p className="home__description">Hello and welcome to my portfolio! Let's connect to discuss how I can help bring your next project to life!</p>
